...
def parse_args():
    ...
    parser.add_argument("--output", type=str, default="/kaggle/output/model", required=False)
    parser.add_argument("--input", type=str, default="/kaggle/input/kaggledatasetfilekaggle", required=False)
